    ...
    function EnterpriseStatistic({
        ...
        return (
            <div className="metric-card">
                ...
                {/* 👇 If children exist → render custom content */}
                {children ? (
                    <div className="metric-details">{children}</div>
                ) : (
                    <div className="metric-value">{value}</div>
                )}
            </div>
                                                    ...
                                                    <div className="metrics-grid" style={{ marginBottom: 20 }}>
                                                        ...
                                                        >
                                                            <div className="mini-stat">
                                                                <span>Durable Shared</span>
                                                                <span>{selectedTopic.DurableShared}</span>
                                                            </div>

                                                            <div className="mini-stat">
                                                                <span>Durable Exclusive</span>
                                                                <span>{selectedTopic.DurableExclusive}</span>
                                                            </div>

                                                            <div className="mini-stat">
                                                                <span>Non Durable</span>
                                                                <span>{selectedTopic.NonDurable}</span>
                                                            </div>
                                                        </EnterpriseStatistic>
